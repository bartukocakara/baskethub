    ...
    return (
        <div class="col-3">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link" id="v-pills-training-teams-tab" data-bs-toggle="pill" href="#v-pills-training-teams" role="tab" aria-controls="v-pills-training-teams" aria-selected="false"> <BsPeopleFill /> Training Teams</a>

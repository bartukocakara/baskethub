const ProfileNavs = () => {
    return (
        <ul className="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li className="nav-item" role="presentation">
                <a className="nav-link" id="requests-tab" data-bs-toggle="tab" href="#requests" role="tab" aria-controls="requests" aria-selected="false">Requests List <span className="badge bg-primary">2</span></a>
            </li>
            <li className="nav-item" role="presentation">
            ...
            <li className="nav-item" role="presentation">
                <a className="nav-link" id="licence-tab" data-bs-toggle="tab" href="#licence" role="tab" aria-controls="licence" aria-selected="false">Licence <span className="badge bg-primary">2</span></a>
            </li>
            <li className="nav-item" role="presentation">

...
const CourtCommentsModal = ({handleManagerCommentsModalClose, show}) => {
    return (
        <>
        <Modal show={show} onHide={handleManagerCommentsModalClose}>
            <Modal.Title className="text-center">Court Comments</Modal.Title>
            <Modal.Body>
                <div class="col-12">
                    <div class="card">
            ...
            <div className="text-center">
                ...
                <Link to="court-comments" variant="warning m-2">
                    See all
                </Link>
            </div>
        </Modal>

                        ...
                        <div class="email-user-list list-group ps ps--active-y">
                            <ul class="users-list-wrapper media-list">
                                ...
                                <li class="media mail-read">
                                    ...
                                    <div class="pr-50">
                                        <div class="avatar">
                                            <img class="rounded-circle" src="assets/images/faces/3.jpg" alt="Generic placeholder" />
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div class="user-details">
                                ...
                                <li class="media">
                                    ...
                                    <div class="pr-50">
                                        <div class="avatar">
                                            <img class="rounded-circle" src="assets/images/faces/7.jpg" alt="Generic placeholder" />
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div class="user-details">
                                ...
                                <li class="media">
                                    ...
                                    <div class="pr-50">
                                        <div class="avatar">
                                            <img class="rounded-circle" src="assets/images/faces/5.jpg" alt="Generic placeholder" />
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div class="user-details">
                                ...
                                <li class="media mail-read">
                                    ...
                                    <div class="pr-50">
                                        <div class="avatar">
                                            <img class="rounded-circle" src="assets/images/faces/8.jpg" alt="Generic placeholder" />
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div class="user-details">

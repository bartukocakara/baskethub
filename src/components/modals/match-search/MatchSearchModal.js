...
const MatchSearchModal = ({handleMatchClose, show}) => {
    return (
        <Modal show={show} onHide={handleMatchClose}>
            <Modal.Header>
                <GoPerson className="sidebar-icon"/>
                <Modal.Title>Match Search</Modal.Title>
            </Modal.Header>
            <form action="#">
            ...
            <div className="text-center">
                <Button variant="secondary m-2" onClick={handleMatchClose}>
                    Close
                </Button>
                <Button variant="warning m-2" onClick={handleMatchClose}>
                    Start search
                </Button>
            </div>
        </Modal>

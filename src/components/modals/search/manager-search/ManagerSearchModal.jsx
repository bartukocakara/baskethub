...
const ManagerSearchModal = ({handleManagerClose, show}) => {
    return (
        <Modal show={show} onHide={handleManagerClose}>
            <Modal.Header>
            ...
            <div className="text-center">
                <Button variant="secondary m-2" onClick={handleManagerClose}>
                    Close
                </Button>
                <Button variant="warning m-2" onClick={handleManagerClose}>
                    Start search
                </Button>
            </div>
        </Modal>

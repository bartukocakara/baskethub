...
const QuitAllStarModal = ({handleQuitAllStarModalClose, show}) => {

    return (
        <>
        <Modal show={show} onHide={handleQuitAllStarModalClose}>
            <Modal.Body>
                <div class="col-12">
                    <div class="card m-3">
            ...
            <div className="text-center">
                ...
                <Button className="" variant="secondary m-2" onClick={handleQuitAllStarModalClose}>
                    Close
                </Button>
...
export default QuitAllStarModal
